...
| `main.py` | FastAPI app entry point: CORS middleware, lifespan (creates/closes TranscriptionService), health endpoint, mounts audio router, conditional StaticFiles mount for Docker |
